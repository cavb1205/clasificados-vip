...
const ACTIONS = [
  ...
  ["publication.expire", "Publicación expirada"],
  ["profile_report.dismiss", "Reporte de perfil descartado"],
  ["profile_report.suspend", "Perfil suspendido por reporte"],
  ["room_report.dismiss", "Reporte de habitación descartado"],
