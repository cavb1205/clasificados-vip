...
urlpatterns = [
    ...
    path("legal-acceptance/", views.LegalAcceptanceView.as_view(), name="legal-acceptance"),
    path("privacy-requests/", views.PrivacyRequestsView.as_view(), name="privacy-requests"),
